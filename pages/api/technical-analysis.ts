...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  console.log("✅ Technical Analysis API triggered");
  ...
  const technicalAnalysisPrompt = getFormattedPrompt('technical', stockName);

  try {
    const result = await aiManager.generateAnalysis(technicalAnalysisPrompt, 'technical');
